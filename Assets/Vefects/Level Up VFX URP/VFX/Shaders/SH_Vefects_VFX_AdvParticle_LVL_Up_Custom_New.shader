	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Color = ( ( ( ( ( float4( lerpResult106 , 0.0 ) * ( IN.ase_color * float4( (Color117).rgb , 0.0 ) ) ) * temp_output_125_0 ) * temp_output_97_0 ) * _EmissiveIntensity ) * IN.ase_texcoord3.w ).rgb;
		...
		Pass
		{
				 ...
				 )
			{
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_125_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + IN.ase_texcoord1.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( IN.ase_color.a * temp_output_125_0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;28;-6160,-2864;Inherit;True;Property;_Distortion_Texture;Distortion_Texture;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;113;-3967.333,-2686.666;Inherit;False;Property;_Color_01;Color_01;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;114;-3968,-2944;Inherit;False;Property;_Color_02;Color_02;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=FFA23F9AB0B8BE417CC93AC42234251028C2AFC1