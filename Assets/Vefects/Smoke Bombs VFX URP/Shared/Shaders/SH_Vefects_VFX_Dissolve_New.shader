	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).r * 0.1 ) * _Distortion );
				...
				float clampResult85 = clamp( ( saturate( ( ( tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( ( tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) ).r * _MaskMove_Power ) * _MaskMove_Multiply ) ) ) , 0.0 , 1.0 );
				...
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).r * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).r ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( clampResult85 * noise84 );
				...
				float3 Color = ( ( ( (_Color).rgb * (IN.ase_color).rgb ) * temp_output_87_0 ) * _Emissive );
				float Alpha = saturate( ( IN.ase_color.a * saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( IN.ase_texcoord4.x + _Dissolve ) ) * distanceDepth94 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float Alpha = saturate( ( IN.ase_color.a * saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( IN.ase_texcoord3.x + _Dissolve ) ) * distanceDepth94 ) ) ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float global_speed22 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord23 = IN.ase_texcoord.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner26 = ( global_speed22 * _NoiseDistortion_Speed + texCoord23);
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).r * 0.1 ) * _Distortion );
				float2 appendResult44 = (float2(_Mask_Speed , 0.0));
				float2 texCoord47 = IN.ase_texcoord.xy * _Mask_Scale + _Mask_Offset;
				float2 panner56 = ( global_speed22 * appendResult44 + texCoord47);
				float2 texCoord59 = IN.ase_texcoord.xy * _MaskMove_Scale + float2( 0,0 );
				float2 appendResult57 = (float2(IN.ase_texcoord1.z , IN.ase_texcoord1.w));
				float clampResult85 = clamp( ( saturate( ( ( tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( ( tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) ).r * _MaskMove_Power ) * _MaskMove_Multiply ) ) ) , 0.0 , 1.0 );
				float2 texCoord40 = IN.ase_texcoord.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = IN.ase_texcoord.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed22 * _Noise_02_Speed + texCoord38);
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).r * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).r ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( clampResult85 * noise84 );
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( IN.ase_texcoord1.x + _Dissolve ) ) * distanceDepth94 ) ) ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float global_speed22 = ( _Global_Speed * _TimeParameters.x );
				float2 texCoord23 = IN.ase_texcoord1.xy * _NoiseDistortion_Scale + float2( 0,0 );
				float2 panner26 = ( global_speed22 * _NoiseDistortion_Speed + texCoord23);
				float Distortion36 = ( ( tex2D( _NoiseDistortion_Texture, panner26 ).r * 0.1 ) * _Distortion );
				float2 appendResult44 = (float2(_Mask_Speed , 0.0));
				float2 texCoord47 = IN.ase_texcoord1.xy * _Mask_Scale + _Mask_Offset;
				float2 panner56 = ( global_speed22 * appendResult44 + texCoord47);
				float2 texCoord59 = IN.ase_texcoord1.xy * _MaskMove_Scale + float2( 0,0 );
				float2 appendResult57 = (float2(IN.ase_texcoord2.z , IN.ase_texcoord2.w));
				float clampResult85 = clamp( ( saturate( ( ( tex2D( _Mask_Texture, ( ( Distortion36 * _DistortionMask ) + panner56 ) ).r * _Mask_Power ) * _Mask_Multiply ) ) * saturate( ( ( tex2D( _MaskMove_Texture, ( texCoord59 + appendResult57 ) ).r * _MaskMove_Power ) * _MaskMove_Multiply ) ) ) , 0.0 , 1.0 );
				float2 texCoord40 = IN.ase_texcoord1.xy * _Noise_01_Scale + float2( 0,0 );
				float2 panner48 = ( global_speed22 * _Noise_01_Speed + texCoord40);
				float2 texCoord38 = IN.ase_texcoord1.xy * _Noise_02_Scale + float2( 0,0 );
				float2 panner54 = ( global_speed22 * _Noise_02_Speed + texCoord38);
				float noise84 = saturate( ( ( ( tex2D( _Noise_01_Texture, ( Distortion36 + panner48 ) ).r * tex2D( _Noise_02_Texture, ( Distortion36 + panner54 ) ).r ) * _Noises_Power ) * _Noises_Multiply ) );
				float temp_output_87_0 = ( clampResult85 * noise84 );
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * saturate( ( ( saturate( ( temp_output_87_0 * _Opacity_Boost ) ) - ( IN.ase_texcoord2.x + _Dissolve ) ) * distanceDepth94 ) ) ) );
				surfaceDescription.AlphaClipThreshold = 0.5;
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-7488,416;Inherit;False;Property;_Global_Speed;Global_Speed;27;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;21;-5184,-1056;Inherit;False;Property;_NoiseDistortion_Scale;NoiseDistortion_Scale;9;0;Create;True;0;0;0;False;0;False;1,1;2,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;25;-4960,-912;Inherit;False;Property;_NoiseDistortion_Speed;NoiseDistortion_Speed;15;0;Create;True;0;0;0;False;0;False;0.2,0.25;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-4000,-944;Inherit;False;Property;_Distortion;Distortion;22;0;Create;True;0;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-3824,-1072;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;32;-8160,-400;Inherit;False;Property;_Noise_02_Scale;Noise_02_Scale;7;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;33;-8304,-1040;Inherit;False;Property;_Noise_01_Scale;Noise_01_Scale;6;0;Create;True;0;0;0;False;0;False;0.8,0.8;2,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;34;-5808,-160;Inherit;False;Property;_Mask_Offset;Mask_Offset;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;35;-5568,-128;Inherit;False;Property;_Mask_Speed;Mask_Speed;28;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;36;-3584,-1072;Inherit;False;Distortion;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;37;-5824,-336;Inherit;False;Property;_Mask_Scale;Mask_Scale;13;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;39;-8080,-864;Inherit;False;Property;_Noise_01_Speed;Noise_01_Speed;10;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;43;-7904,-240;Inherit;False;Property;_Noise_02_Speed;Noise_02_Speed;11;0;Create;True;0;0;0;False;0;False;-0.2,0.4;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-5296,-384;Inherit;False;Property;_DistortionMask;DistortionMask;23;0;Create;True;0;0;0;False;0;False;0;3.65;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;52;-5520,272;Inherit;False;Property;_MaskMove_Scale;MaskMove_Scale;12;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;62;-7216,-864;Inherit;True;Property;_Noise_01_Texture;Noise_01_Texture;0;0;Create;True;0;0;0;False;0;False;-1;301564cad965bbb4da5072b5cf9406cb;301564cad965bbb4da5072b5cf9406cb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-4544,-64;Inherit;False;Property;_Mask_Power;Mask_Power;19;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;67;-4592,496;Inherit;False;Property;_MaskMove_Power;MaskMove_Power;21;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-6864,-432;Inherit;False;Property;_Noises_Power;Noises_Power;20;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-6640,-416;Inherit;False;Property;_Noises_Multiply;Noises_Multiply;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-4352,-48;Inherit;False;Property;_Mask_Multiply;Mask_Multiply;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;-6656,-656;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-4384,512;Inherit;False;Property;_MaskMove_Multiply;MaskMove_Multiply;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;79;-4208,272;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;80;-6304,-656;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;81;-4032,288;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-3104,944;Inherit;False;Property;_Opacity_Boost;Opacity_Boost;24;0;Create;True;0;0;0;False;0;False;5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;89;-3056,800;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;-2864,848;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;92;-2624,1248;Inherit;False;Property;_Dissolve;Dissolve;29;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-1888,1120;Inherit;False;Property;_Opacity_DepthDistance;Opacity_DepthDistance;25;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;95;-2576,864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;96;-2464,1072;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;98;-2272,848;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;-1184,1840;Inherit;False;Property;_CamOffSet;CamOffSet;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;120;-936.7117,1037.586;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;11;512,0;Inherit;False;Property;_Cull;Cull;30;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;768,0;Inherit;False;Property;_Src;Src;31;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;1024,0;Inherit;False;Property;_Dst;Dst;32;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;1280,0;Inherit;False;Property;_ZWrite;ZWrite;33;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;1536,0;Inherit;False;Property;_ZTest;ZTest;34;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;-768,0;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;113;-2960,96;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;114;-1808,-400;Inherit;False;Property;_Color;Color;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-960,160;Inherit;False;Property;_Emissive;Emissive;26;0;Create;True;0;0;0;False;0;False;1;40;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;118;-1168,-16;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=615B991C660BCA72A1B88BA9D390911937F041E8