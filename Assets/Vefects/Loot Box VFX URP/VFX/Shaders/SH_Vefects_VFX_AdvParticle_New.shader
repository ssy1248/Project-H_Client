...
Shader "Vefects/SH_Vefects_VFX_AdvParticle_New"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord107 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + IN.ase_texcoord3.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( IN.ase_color.a * temp_output_86_0 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( ( float4( lerpResult106 , 0.0 ) * ( IN.ase_color * float4( (Color117).rgb , 0.0 ) ) ) * temp_output_86_0 ) * temp_output_97_0 ) * _EmissiveIntensity ) * IN.ase_texcoord3.w ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + IN.ase_texcoord2.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( IN.ase_color.a * temp_output_86_0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + IN.ase_texcoord.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( IN.ase_color.a * temp_output_86_0 ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 panner27 = ( windSpeed22 * _Distortion_Speed + ( texCoord21 * _Distortion_Scale ));
				float Distortion37 = ( ( tex2D( _Distortion_Texture, panner27 ).r * 0.1 ) * _Distortion_Amount );
				float2 texCoord50 = IN.ase_texcoord1.xy * _Mask_Scale + _Mask_Offset;
				float4 tex2DNode58 = tex2D( _Mask_Texture, ( ( Distortion37 * _DistortionMaskIntensity ) + texCoord50 ) );
				float temp_output_67_0 = saturate( ( pow( tex2DNode58.r , _Mask_Power ) * _Mask_Multiply ) );
				...
				float screenDepth79 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth79 = saturate( ( screenDepth79 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float temp_output_86_0 = saturate( ( saturate( ( saturate( ( temp_output_67_0 - ( _Erosion_Sub + IN.ase_texcoord1.z ) ) ) * saturate( lerpResult69 ) ) ) * distanceDepth79 ) );
				float temp_output_97_0 = saturate( ( IN.ase_color.a * temp_output_86_0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;28;-6160,-2864;Inherit;True;Property;_Distortion_Texture;Distortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;51;-8704,-1136;Inherit;True;Property;_Erosion_Texture;Erosion_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;113;-3968,-2688;Inherit;False;Property;_ColorTop;Color Top;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;114;-3968,-2944;Inherit;False;Property;_ColorBottom;Color Bottom;3;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B64437C3BCBA9C8353D6B084A567571C8F1A5A80